...
console.log(universities);//unsorted
console.log(universities.sort());//sorted
...
const unisWithUni = [];
const isUni = graduates.map(function(unisWuni){
  if(unisWuni.university.includes('Uni')){
    unisWithUni.push(unisWuni.university);
  }
});
...
zooAnimals.forEach((name) =>{
  console.log("Name: " + name.animal_name + ", " + "Scientific Name: " + name.scientific_name);
})
...
const toLowerCase = zooAnimals.map(function(animal){
